...
public class Solution {
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        private static AtomicInteger fCount=new AtomicInteger(0);

        public AmigoThreadFactory(){
            factoryNum.set(fCount.incrementAndGet());
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String name=thread.getThreadGroup().getName()+"-pool-"+factoryNum+"-thread-"+integer.incrementAndGet();
            thread.setName(name);
            return thread;
        }
    }
