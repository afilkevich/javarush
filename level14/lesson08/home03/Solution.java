...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        String a="";
        while (true)//read line in String a,and equal with words "user",""looser,"coder"....if true -add in list
        {
             a =reader.readLine();
            if (a.equals("user")||(a.equals("looser"))|| (a.equals("coder"))||(a.equals("proger"))) {list.add(a);}
              else   break;
        }
