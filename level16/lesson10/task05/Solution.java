...
public class Solution {
    ...
    public static void ourInterruptMethod() {
        for (Thread a:threads){a.interrupt();}
    ...
    public static class Water implements Runnable {
        ...
        public void run() {
             Thread threadThis=Thread.currentThread();  //fix 2 variables - исправь 2 переменных
            boolean isCurrentThreadInterrupted =threadThis.isInterrupted();
            String threadName = threadThis.getName();
