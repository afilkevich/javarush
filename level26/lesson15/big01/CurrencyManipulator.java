...
public class CurrencyManipulator
{
  ...
  private  Map<Integer,Integer> denominations;
    ...
    /*
    Подсчитывает общую сумму денег для выбранной валюты
     */
...
/*
метод будет показывать, добавлены ли какие-то банкноты или нет
 */
    public boolean hasMoney(){
        ...
        if (denominations.isEmpty()) result=false;
            ...
            if (count==denominations.size()) result=false;
        }
        return result;
    }
